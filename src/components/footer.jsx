...
<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-300 mb-4">
            Discover delicious meals with TheMenuFy. Customize your orders and enjoy a seamless dining experience.
          </p>
          <div className="flex space-x-4">
            <a href="https://twitter.com" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-yellow-400">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z" />
              </svg>
            </a>
            <a href="https://facebook.com" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-yellow-400">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M22 12a10 10 0 10-11 10V14H9v-2h2V9.5A2.5 2.5 0 0113.5 7H16v2h-2a.5.5 0 00-.5.5V12h2.5l-.5 2H13v8a10 10 0 009-10z" />
              </svg>
            </a>
            <a href="https://plus.google.com" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-yellow-400">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div>
          ...
          <p className="text-sm text-gray-300 mb-2">
            📧 <a href="mailto:support@themenufy.com" className="hover:text-yellow-400">support@themenufy.com</a>
          </p>
          <p className="text-sm text-gray-300">
            📞 <a href="tel:+198101000000" className="hover:text-yellow-400">+1 (981) 010 000 000</a>
          </p>
        </div>
        ...
        {/* Support & Downloads */}
        <div>
          <h3 className="text-lg font-semibold mb-4 text-yellow-400">Support & Downloads</h3>
          <p className="text-sm text-gray-300 mb-4">
      ...
      <div className="mt-10 border-t border-gray-700 pt-4 text-center">
        <p className="text-sm text-gray-300">
          © {new Date().getFullYear()} TheMenuFy. All rights reserved. | Updated on {formattedDate}
        </p>
        <p className="text-sm text-gray-300 mt-1">
          Designed & Developed by{" "}
          <a href="http://codemaster4twin6.com/" target="_blank" rel="noreferrer" className="text-yellow-400 hover:underline">
            CodeMaster 4Twin 6
          </a>
        </p>
      </div>
